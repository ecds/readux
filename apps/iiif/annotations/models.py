...
class Annotation(models.Model):
    ...
    oa_annotation = JSONField(default=dict, blank=False)
    """
    <svg style='height: 22px;' viewBox="0 0 126 22"><text x='0' y='100%' textLength='100%' style='font-size: 22px; user-select: all;'>Entered</text></svg>
    <span style='height: 22px; width: 126px; font-size: 22px;'>
    """
...
@receiver(signals.pre_save, sender=Annotation)
def set_svg(sender, instance, **kwargs):
    instance.oa_annotation['@id'] = str(instance.pk)
