...
import edtf.fields
from edtf import parse_edtf, text_to_edtf, struct_time_to_jd
...
def dates_to_edtf(apps, _):  # pylint: disable=redefined-outer-name
    ...
    for manifest in manifests:
        ...
        if edtf_standard_date:
            ...
            manifest.date_earliest = struct_time_to_jd(getattr(date_edtf, "lower_fuzzy")())
            manifest.date_latest = struct_time_to_jd(getattr(date_edtf, "upper_fuzzy")())
