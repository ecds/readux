...
class Manifest(IiifBase):
    ...
    logo_url = models.URLField(
        blank=True,
        help_text = "URL for thumbnail of holding institution's logo"
    )
...
@receiver(signals.pre_save, sender=Manifest)
def clear_logo_url_on_logo_upload(sender, instance, **kwargs):
    """
    Clears logo_url on logo file upload
    """
    # for existing manifests, clear out the logo_url if a logo file is uploaded
    if instance.pk and instance.logo and instance.logo_url:
        instance.logo_url = ""
