...
urlpatterns = [
    path(
        "collection/<collection>/", views.CollectionDetail.as_view(), name="collection"
    ),
    ...
    path(
        "annotations/", annotations.Annotations.as_view(), name="post_user_annotations"
    ),
    path(
    ...
    path(
        "annotations-crud/",
        annotations.AnnotationCrud.as_view(),
        name="crud_user_annotation",
    ),
    path("search/", views.VolumeSearchView.as_view(), name="search"),
    path(
        "_anno_count/<volume>/<page>",
        views.AnnotationCount.as_view(),
        name="_anno_count",
    ),
    ...
    path(
        "annotation_count/<username>/<manifest>",
        annotations.AnnotationCountByCanvas.as_view(),
        name="annotation_count_by_canvas",
    ),
]
