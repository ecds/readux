# -*- coding: utf-8 -*-
#
# Readux documentation build configuration file, created by
...
project = u'Readux'
copyright = u'2014, Emory University Libraries'
...
version = '%d.%d' % readux.__version_info__[:2]
# The full version, including alpha/beta/rc tags.
release = readux.__version__
...
latex_documents = [
  ('index', 'Readux.tex', u'Readux Documentation',
...
man_pages = [
    ('index', 'readux', u'Readux Documentation',
     [u'Emory University Libraries'], 1)
]
...
texinfo_documents = [
  ('index', 'Readux', u'Readux Documentation',
   u'Emory University Libraries', 'Readux', 'One line description of project.',
   'Miscellaneous'),
]
